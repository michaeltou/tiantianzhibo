...
- (void)setPlayerModel:(PlayerModel *)playerModel
{
   ...
   /*
    UIImage *iconImage = [[UIImage alloc] initWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://img.meelive.cn/%@",playerModel.portrait]]
                                                    ]];
    [_iconImage setImage:iconImage];
    
    UIImage *coverImage = [[UIImage alloc] initWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://img.meelive.cn/%@",playerModel.portrait]]
                                                    ]];
    [_coverImage setImage:coverImage];
